...
func newRequestsTableImpl(schemaName, tableName, alias string) requestsTable {
	var (
		...
		allColumns              = postgres.ColumnList{IDColumn, CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn, StatusColumn, WorkflowVersionIDColumn}
		mutableColumns          = postgres.ColumnList{CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn, StatusColumn, WorkflowVersionIDColumn}
	)
