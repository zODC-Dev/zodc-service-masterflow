...
type nodesTable struct {
	...
	IsSendForm                postgres.ColumnBool
...
func newNodesTableImpl(schemaName, tableName, alias string) nodesTable {
	var (
		...
		IsSendFormColumn                = postgres.BoolColumn("is_send_form")
