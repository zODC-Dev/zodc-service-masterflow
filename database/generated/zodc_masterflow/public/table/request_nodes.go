...
type requestNodesTable struct {
	...
	WorkflowNodeID postgres.ColumnInteger
...
func newRequestNodesTableImpl(schemaName, tableName, alias string) requestNodesTable {
	var (
		...
		WorkflowNodeIDColumn = postgres.IntegerColumn("workflow_node_id")
		FormDataIDColumn     = postgres.IntegerColumn("form_data_id")
		allColumns           = postgres.ColumnList{IDColumn, CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn, KeyColumn, TitleColumn, AssigneeIDColumn, DueInColumn, EndTypeColumn, StatusColumn, RequestIDColumn, WorkflowNodeIDColumn, FormDataIDColumn}
		mutableColumns       = postgres.ColumnList{CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn, KeyColumn, TitleColumn, AssigneeIDColumn, DueInColumn, EndTypeColumn, StatusColumn, RequestIDColumn, WorkflowNodeIDColumn, FormDataIDColumn}
	)
	...
	return requestNodesTable{
		...
		WorkflowNodeID: WorkflowNodeIDColumn,
