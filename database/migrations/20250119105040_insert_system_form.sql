...
VALUES
    ...
    ('{"tooltip": null, "helpText": null, "maxChars": null, "validation": null, "placeholder": "Sprint", "defaultValue": null}'::jsonb, 2, false, 'BASIC_FIELD', 'Text', 'format_color_text', 'sprint__JSON__:name', 'TEXT', 'Sprint', 1),
    ('{"tooltip": null, "helpText": null, "maxChars": null, "validation": null, "placeholder": "Assignee", "defaultValue": null}'::jsonb, 2, false, 'BASIC_FIELD', 'Text', 'format_color_text', 'assignee__JSON__:name', 'TEXT', 'Assignee', 1),
    ...
    ('{"tooltip": null, "helpText": null, "maxChars": null, "validation": null, "placeholder": "Story Point Estimate", "defaultValue": null}'::jsonb, 3, false, 'BASIC_FIELD', 'Text', 'format_color_text', 'estimatePoint', 'TEXT', 'Story Point Estimate', 1);
